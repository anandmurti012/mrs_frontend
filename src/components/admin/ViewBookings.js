...
//   const handlePasscodeSubmit = () => {
//     if (passcode === '1234') { // Replace '1234' with the actual passcode
//       if (actionType === 'confirm') {
//         handleConfirm(selectedBooking.bookingId);
//       } else if (actionType === 'cancel') {
//         handleCancel(selectedBooking.bookingId);
...
//               </div>
//               <div className="modal-footer">
//                 <button className="btn btn-success" onClick={() => openPasscodeModal('confirm')}>Confirm</button>
//                 <button className="btn btn-danger" onClick={() => openPasscodeModal('cancel')}>Cancel</button>
...
//         <div className="modal-header">
//           <h5 className="modal-title">Enter Passcode</h5>
//           <button type="button" className="close" onClick={closePasscodeModal}>&times;</button>
//         </div>
//         <div className="modal-body">
//           <input
//             type="password"
...
//         </div>
//         <div className="modal-footer">
//           <button className="btn btn-primary" onClick={handlePasscodeSubmit}>Submit</button>
//           <button className="btn btn-secondary" onClick={closePasscodeModal}>Cancel</button>
//         </div>
//       </div>
//     </div>
//   </div>
